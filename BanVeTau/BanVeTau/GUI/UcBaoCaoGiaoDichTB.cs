...
{
    public partial class UcBaoCaoGiaoDichTB : UserControl
    {
        public UcBaoCaoGiaoDichTB()
        {
            InitializeComponent();
        }

        private void UcBaoCaoGiaoDichThatBai_Load(object sender, EventArgs e)
        {
            Dock = DockStyle.Fill;
        ...
        private void cbLichTrinh_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            try
            {
                view_GiaoDichTableAdapter.Fill(veTauDataSet.View_GiaoDich, (int) cbLichTrinh.SelectedValue,
                    cbDoanTau.SelectedValue.ToString(), true);
